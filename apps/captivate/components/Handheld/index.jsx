        ...
        <Grid>
            <GridColumn start={2} end={6} className={Style.col}>
                ...
                <Card theme="opaque" className={Style.touchCard}>
                    <Link className={Style.cardLink}  href={{ href: "handheld", query: { step: 1 }}}>
                        ...
                        <h2 className={Style.cardHeading}>
                            Standard & Guest Sign-in
                        </h2>
                    </Link>
                </Card>

                <Card theme="opaque" className={Style.touchCard}>
                    <Link className={Style.cardLink} href={{ href: "handheld", query: { step: 2 }}}>
