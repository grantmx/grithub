        ...
        <Grid className={Style.home}>
            <GridColumn start={2} end={6} className={Style.col}>
                ...
                <Card theme="opaque" className={Style.touchCard} noMargin>
                    <Link className={Style.cardLink} href={{ href: "handheld", query: { goto: 6, current: 1 }}}>
                ...
                {/* <div className={Style.helpText}>
                    <p className={Style.text}>
                        <small>*GRIT Hub Members can speed up their sign-in by taping their member card or their mobile phone using our app.</small>
                    </p>
                </div> */}
            </GridColumn>
