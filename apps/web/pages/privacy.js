        ...
        >
            <section className="container-fluid d-flex justify-content-center align-items-center py-5 flex-column" id="programs-workshops">
                <article className="col-12 col-md-8">
                    ...
                    <p>When you are using our secure online store the information you give, such as your credit card number and contact information is provided so that the transaction can take place. Your credit card information is secured through PayPal. </p>
                    <h3>ACCESS AND ADMENDING THE INFORMATION WE HOLD </h3>
