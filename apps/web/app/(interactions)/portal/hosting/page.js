        ...
        <section className="container-xxl d-flex p-md-5 p-4 flex-column mb-5" id="coworking">
            <div className="col-12 d-flex flex-column">
                ...
                <p className="fs-4 text-center mb-5">
                    ...
                    <a className="btn rounded-pill btn-primary btn-lg mt-3 d-inline-flex align-items-center py-3 px-5" href="https://www.payfast.co.za/eng/process?cmd=_paynow&receiver=19823624&item_name=Monthly+Website+Hosting+Fee&email_confirmation=1&confirmation_address=marshall@grithub.org.za&item_description=Recurring+website+hosting+fee+at+R79+per+month.&return_url=https://grithub.org.za/success&cancel_url=https://grithub.org.za/cancel&amount=79&subscription_type=1&recurring_amount=79&cycles=0&frequency=3">
                ...
                <p className="fs-4 text-center">
                    If you have any questions regarding your website hosting<br/> send us an email at <a href="mailto:workforce@grithub.org.za">workforce@grithub.org.za</a> or <a href="https://wa.me/270630705752">WhatsApp Us</a>
                </p>
            </div>
        </section>       
    )
