                ...
                <div className="col-12 d-flex flex-md-row flex-column mt-3">
                    <div className="col-12 col-md-8 pe-md-5">
                        ...
                        <ul>
                            ...
                            <li><strong>August 31</strong> - Deadline for final applications.  Applications must be submitted by August 31 at 11:59 PM.</li>
                    ...
                    <div className="col-12 col-md-4">
                        ...
                        <div className={clsx(Style.apply, "shadow-lg")}>
                            ...
                            <Link href="/incubation/competition/apply" className="btn rounded-pill btn-danger">
                                Apply Now
                            </Link>
