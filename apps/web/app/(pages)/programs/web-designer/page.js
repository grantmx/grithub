    ...
    <section className="container-xxl d-flex flex-column mb-5">
      ...
      <div className="col-12 d-flex flex-md-row flex-column mt-3">
        <div className="col-12 col-md-8 pe-md-5">
          ...
          <p>
            You will learn HTML, CSS, JavaScript, and an introduction to using AI to help you code. 
            This class is for those who want to learn to code and build websites and web applications.
          </p>
          ...
          <p>
            All students will need to bring their own laptop computer. Mac or PC with enough space 
            to run and install software.
          </p>
          ...
          <div className="accordion mt-3" id="syllabusAccordion">
              ...
              <div id="week1" className="accordion-collapse collapse show" data-bs-parent="#syllabusAccordion">
                <div className="accordion-body">
                  <ul>
                    ...
                    <li><strong>Project:</strong> Create your first personal webpage</li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div id="week2" className="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                <div className="accordion-body">
                  <ul>
                    ...
                    <li><strong>Project:</strong> Style your personal webpage</li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div id="week3" className="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                <div className="accordion-body">
                  <ul>
                    ...
                    <li><strong>Project:</strong> Build an interactive calculator</li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div id="week4" className="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                <div className="accordion-body">
                  <ul>
                    ...
                    <li><strong>Project:</strong> Create a to-do list application</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="accordion-item">
              ...
              <div id="week5" className="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                <div className="accordion-body">
                  <ul>
                    ...
                    <li><strong>Project:</strong> Build a simple React component library</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="accordion-item">
              ...
              <div id="week6" className="accordion-collapse collapse" data-bs-parent="#syllabusAccordion">
                <div className="accordion-body">
                  <ul>
                    ...
                    <li><strong>Final Project:</strong> Build and deploy a complete web application</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="alert alert-success mt-4">
            <strong>🎓 Career Opportunities:</strong> After completing this course, you'll be prepared for entry-level frontend developer positions, freelance work, or continue with advanced courses in React and Next.js.
          </div>

          <div className="alert alert-info mt-4">
            <strong>Next Session:</strong> Starting Saturday, April 2026. Limited seats available!
          </div>
        </div>
