    ...
    return(
            <section className="container-fluid d-flex justify-content-center align-items-center py-5 flex-column" id="programs-workshops">
                <article className="col-12 col-md-8">
                    ...
                    <br/>
                    <h2 className="display-5">DATA CONTROLLER</h2>
                    ...
                    <h2 className="display-5">INFORMATION COLLECTED </h2>
                    ...
                    <h2 className="display-5">OUR USE OF PERSONAL INFORMATION </h2>
                    <ol>
                    ...
                    <h2 className="display-5">Adherence to the POPI Act:</h2>
                    ...
                    <h2 className="display-5">Online Registration and Application Submissions</h2>
                    ...
                    <h2 className="display-5">ONLINE PAYMENTS </h2>
                    ...
                    <h2 className="display-5">ACCESS AND AMENDING THE INFORMATION WE HOLD </h2>
                    ...
                    <h2 className="display-5">OTHER MATTERS </h2>
                    <ol>
