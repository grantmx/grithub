    ...
    return(
            ...
            <section className="container-fluid d-flex justify-content-center align-items-center py-5 flex-column" id="programs-workshops">
                <article className="col-12 col-md-8">
				    ...
				    <p className="lead">The Garden Route Innovation & Technology Hub, NPC / PBO ("GRIT Hub") provides this website, its features, and services (collectively the “Service”) subject to the following conditions (“Terms”) which constitute a legally binding agreement between you, whether personally or on behalf of an entity (“you”), and GRIT Hub.&nbsp; The Terms apply to you and all visitors and others who access the Service (“Users”).&nbsp; By accessing or using any part of the website or Service, you signify that you have read, understood and accept the Terms and any policies, notices or other provisions incorporated by reference.&nbsp; GRIT Hub reserves the right to amend the Terms at any time without notice and such changes are effective immediately upon posting.&nbsp; Please review the Terms frequently for changes because your continued use of the Service constitutes acceptance of any new Terms.&nbsp; If you do not agree to the Terms or any subsequent modification, do not access or use the Service.</p>
                    ...
                    <h2 className="display-5 mt-5" id="about-grit-hub">
                        <a href="#about-grit-hub" className={Style.headerAnchor}>About GRIT Hub</a>
                    </h2>
                    ...
                    <p>GRIT Hub may receive funding through donations, grants, sponsorships, and other contributions from individuals, organisations, and institutions. All donations received are applied toward advancing GRIT Hub’s mission of digital skills development, workforce training, entrepreneurship support, and innovation ecosystem development.</p>

                    <p>Where applicable, GRIT Hub may issue donation receipts in accordance with the requirements of the Income Tax Act, including Section 18A provisions, subject to compliance with all regulatory requirements. The issuance of such receipts remains at the sole discretion of GRIT Hub and is dependent on the nature of the donation and applicable legal guidelines.</p>

                    <p>Unless explicitly agreed in writing, donations made to GRIT Hub are voluntary, non-refundable, and do not entitle the donor to any goods, services, or direct financial benefit. Donations do not create any ownership, partnership, or decision-making rights within the organisation.</p>

                    <p>GRIT Hub will make reasonable efforts to ensure that donated funds are used for their intended purpose; however, GRIT Hub reserves the right to allocate funds where they are most needed in order to achieve its mission and ensure the sustainability of its programmes.</p>
                    ...
                    <h3>Booking Guarantee and Cancellations</h3>
                    ...
                    <h2 className="display-5  mt-5" id="use-of-services">
                        <a href="#use-of-services" className={Style.headerAnchor}>Use of Services</a>
                    </h2>
                    ...
                    <p>The Service is controlled and operated from its facilities in Western Cape, South Africa.&nbsp; GRIT Hub makes no representations that the Service is appropriate or available for use in other locations. &nbsp;Those who access or use the Service from other jurisdictions do so at their own volition and are entirely responsible for compliance with all applicable South African and local laws and regulations, including but not limited to export and import regulations. You may not use the Service if you are a resident of a country embargoed by the South Africa, or are a foreign person or entity blocked or denied by the South African government.&nbsp; Unless otherwise explicitly stated, all materials found on the Service are solely directed to individuals, companies, or other entities located in South Africa.</p>

                    <p>By providing GRIT Hub with your e-mail address you consent to our using the e-mail address to send you Service-related notices, including any notices required by law, in lieu of communication by postal mail. &nbsp; If you decide you do not want to receive such email messages, you may opt out. &nbsp;Opting out may prevent you from receiving e-mail messages regarding updates about your application for employment or similar notifications.</p>

                    <p>Subject to the Terms, GRIT Hub grants you a limited, revocable, nonexclusive personal right to access the Service. GRIT Hub grants you a limited, revocable, and nonexclusive right to create a hyperlink to the Service so long as the link does not portray GRIT Hub, its products or services in a false, misleading, derogatory or otherwise offensive manner.&nbsp;GRIT Hub reserves all rights not expressly granted herein. GRIT Hub may terminate this license at any time for any reason or no reason.</p>

                    <p>GRIT Hub may permanently or temporarily terminate, suspend, or otherwise refuse to permit your access to the Service without notice and liability for any reason, including if in GRIT Hub's sole determination you violate any provision of the Terms, or for no reason. &nbsp;Upon termination for any reason or no reason, you continue to be bound by the Terms.</p>

                    <p>All aspects of the Service are subject to change or elimination at GRIT Hub's sole discretion. GRIT Hub reserves the right to interrupt the Service with or without prior notice for any reason or no reason. &nbsp;You agree that GRIT Hub will not be liable to you for any interruption of the Service, delay or failure to perform.</p>
                    ...
                    <h2 className="display-5 mt-5" id="grit-hubs-content">
                        <a href="#grit-hubs-content" className={Style.headerAnchor}>GRIT Hub's Content</a>
                    </h2>
                    ...
                    <h2 className="display-5 mt-5" id="products-from-grit-hub">
                        <a href="#products-from-grit-hub" className={Style.headerAnchor}>Products from GRIT Hub</a>
                    </h2>
                    ...
                    <h2 className="display-5 mt-5" id="general-information">
                        <a href="#general-information" className={Style.headerAnchor}>General Information</a>
                    </h2>
                    ...
                    <h2 className="display-5 mt-5" id="indemnity">
                        <a href="#indemnity" className={Style.headerAnchor}>Indemnity</a>
                    </h2>
                    ...
                    <h2 className="display-5 mt-5" id="no-warranty">
                        <a href="#no-warranty" className={Style.headerAnchor}>No Warranty</a>
                    </h2>
                    ...
                    <h2 className="display-5 mt-5" id="limitation-of-liability">
                        <a href="#limitation-of-liability" className={Style.headerAnchor}>Limitation of Liability</a>
                    </h2>
                    ...
                    <h2 className="display-5 mt-5" id="general">
                        <a href="#general" className={Style.headerAnchor}>General</a>
                    </h2>
                    ...
                    <p><strong>Notification Procedures.</strong> GRIT Hub may provide notifications, whether such notifications are required by law or are for marketing or other business related purposes, to you via email notice, written or hard copy notice, or through conspicuous posting of such notice on our website, as determined by GRIT Hub in our sole discretion. GRIT Hub reserves the right to determine the form and means of providing notifications to our Users, provided that you may opt out of certain means of notification as described in the Terms and in the Privacy Policy.</p>

                    <p><strong>Entire Agreement/Severability</strong>. &nbsp;The Terms, together with any other legal notices and agreements published by GRIT Hub via the Service, shall constitute the entire agreement between you and GRIT Hub concerning the Service. &nbsp;If any provision of the Terms is deemed invalid by a court of competent jurisdiction, the invalidity of such provision shall not affect the validity of the remaining provisions of the Terms, which shall remain in full force and effect.&nbsp; To the extent of any conflict between GRIT Hub’s Privacy Policy and these Terms, these Terms shall control.</p>

                    <p><strong>No Waiver.</strong> &nbsp;No waiver of any term of the Terms shall be deemed a further or continuing waiver of such term or any other term, and GRIT Hub's failure to assert any right or provision under the Terms shall not constitute a waiver of such right or provision.</p>
