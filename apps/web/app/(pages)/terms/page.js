    ...
    return(
            ...
            <section className="container-fluid d-flex justify-content-center align-items-center py-5 flex-column" id="programs-workshops">
                <article className="col-12 col-md-8">
                    ...
                    <p><strong>Notification Procedures.</strong> The Company may provide notifications, whether such notifications are required by law or are for marketing or other business related purposes, to you via email notice, written or hard copy notice, or through conspicuous posting of such notice on our website, as determined by the Company in our sole discretion. The Company reserves the right to determine the form and means of providing notifications to our Users, provided that you may opt out of certain means of notification as described in the Terms and in the Privacy Policy.</p>

                    <p><strong>Entire Agreement/Severability</strong>. &nbsp;The Terms, together with any other legal notices and agreements published by the Company via the Service, shall constitute the entire agreement between you and the Company concerning the Service. &nbsp;If any provision of the Terms is deemed invalid by a court of competent jurisdiction, the invalidity of such provision shall not affect the validity of the remaining provisions of the Terms, which shall remain in full force and effect.&nbsp; To the extent of any conflict between the Company’s Privacy Policy and these Terms, these Terms shall control.</p>

                    <p><strong>No Waiver.</strong> &nbsp;No waiver of any term of the Terms shall be deemed a further or continuing waiver of such term or any other term, and the Company's failure to assert any right or provision under the Terms shall not constitute a waiver of such right or provision.</p>

                    <p>These Terms of Use are effective as of January 1, 2021.</p>
